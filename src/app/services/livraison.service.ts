...
export class LivraisonService {
  private apiUrl = 'http://localhost:8081/livraisons';
  private simulatedPosition = new BehaviorSubject<any>(null);

  constructor(private http: HttpClient) {}

  // filepath: c:\Users\bensl\Desktop\Validation systeme distribué\Front\src\app\services\livraison.service.ts
  createLivraison(livraison: any): Observable<any> {
    return this.http.post(`${this.apiUrl}`, livraison).pipe(
      catchError((error) => {
